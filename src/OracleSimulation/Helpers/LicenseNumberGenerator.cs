...
{
  private static LicenseNumberGenerator _instance;
  private string _validLicenseNumberChars = "DFGHJKLNPRSTXYZ";
  private Random _rnd;

  private LicenseNumberGenerator()
  {
    _rnd = new Random();
  }

  public static LicenseNumberGenerator GetInstance()
  {
    if (_instance == null)
    {
      _instance = new LicenseNumberGenerator();
    }
    return _instance;
  }

  public string GenerateRandomLicenseNumber()
  {
