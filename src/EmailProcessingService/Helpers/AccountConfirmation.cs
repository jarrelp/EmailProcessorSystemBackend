            ...
            <mj-body>
                ...
                <mj-column>
                    ...
                    <tr>
                        ...
                        <td class=""ecm-tablecell bold"">{data.Data.Recipient.FirstName} {data.Data.Recipient.SurName}</td>
                    </tr>
                    <tr>
                        <td class=""ecm-tablecell nowrap bold"">E-mailadres:</td>
                        <td class=""ecm-tablecell"">{data.Data.Recipient.EmailAddress}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class=""ecm-tablecell nowrap bold"">Registratiedatum:</td>
                        <td class=""ecm-tablecell"">Activation link: {data.Data.AccountConfirmationData.ActivationLink}</td>
                    </tr>
                    </mj-table>
                </mj-column>
                </mj-section>
