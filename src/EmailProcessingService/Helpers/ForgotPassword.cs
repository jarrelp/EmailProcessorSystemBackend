      ...
      OracleDataEvent data)
    {
        ...
        <mjml>
            ...
            <mj-body>
                ...
                <mj-section>
                <mj-column>
                    <mj-text font-size=""20px"">Wachtwoord vergeten</mj-text>
                </mj-column>
                </mj-section>
                <mj-section>
                <mj-column>
                ...
                <mj-section>
                <mj-column>
                    <mj-text> Beste meneer/mevrouw {data.Data.Recipient.SurName}, </mj-text>
                    <mj-text>
                    We hebben een verzoek ontvangen om het wachtwoord opnieuw in te
                    stellen voor je account. Hieronder vind je de instructies om je
                ...
                <mj-section>
                <mj-column>
                    <mj-text> {data.Data.ForgotPasswordData.ResetInstructions} </mj-text>
                </mj-column>
                </mj-section>
                ...
                <mj-column>
                    <mj-text>
                    Als je dit wachtwoord niet hebt aangevraagd, hoef je verder geen actie
                    te ondernemen. Je kunt dit bericht negeren.
                    </mj-text>
                </mj-column>
                </mj-section>
                ...
                <mj-column>
                    ...
                    Dit is een automatisch gegenereerd bericht. Gelieve niet te
                    antwoorden.
                    </mj-text>
                </mj-column>
                </mj-section>
